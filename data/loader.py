...
class PularStarData(DataLoader):
    def __init__(self, path='data/pulsar_stars.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
...
class VoiceData(DataLoader):
    def __init__(self, path='data/voice.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)

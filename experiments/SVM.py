...
class SVMExperiment(experiments.BaseExperiment):
    ...
    def perform(self):
        ...
        if self._details.ds_name == "QSARbiodegradationData":
            best_params_linear = {'C': 0.501, 'class_weight': 'balanced', 'loss': 'squared_hinge',
                               'max_iter': 1185, 'tol': 0.07000001}
            best_params_rbf = {'C': 0.751, 'class_weight': 'balanced', 'decision_function_shape': 'ovo',
                            'gamma': 0.024390244, 'max_iter': -1, 'tol': 0.06000001}
        # Dataset 2:
        if self._details.ds_name == "VoiceData":
            best_params_linear = {'C': 0.251, 'class_weight': 'balanced', 'loss': 'hinge', 'dual': True,
                               'max_iter': 395, 'tol': 1.00E-08}
            best_params_rbf = {'C': 2.001, 'class_weight': 'balanced', 'decision_function_shape': 'ovo',
                            'gamma': 0.25, 'max_iter': -1, 'tol': 0.09000001}
